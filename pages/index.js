  ...
  return (
    <Layout>
		...
		<div className={styles.pqalugar}>
				...
				<Image width={139} height={138} src={agilidade}/>
				...
				<div className={styles.boxsoptions}>
				<Image width={173} height={168} src={seguranca}/>
				...
				<div className={styles.boxsoptions}>
				<Image width={160} height={160} src={economia}/>
				...
				<div className={styles.boxsoptions}>
				<Image width={129} height={129} src={facilidade}/>
		...
		<div className={styles.tresmodas}>
				...
				<a href="#" className={styles.optresmodas}>QUERO SER MOTOFASTER</a>
				</div>
				<div className={styles.boxsoptionsmodes}>
				<h1 className={styles.number}>3</h1>
				<h2>PARA EMPRESA</h2>
				<p>Encontre um Motofaster parara a sua empresa, de acordo com a sua região!
QUERO um motofaster</p>
				<a href="#" className={styles.optresmodas}>QUERO UM MOTOFASTER</a>
				</div>
		</div>
    </Layout>
  )
